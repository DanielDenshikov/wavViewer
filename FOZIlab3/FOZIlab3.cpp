...
// FOZIlab3.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CFOZIlab3App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CFOZIlab3App

CFOZIlab3App::CFOZIlab3App()
{
...
// Единственный объект CFOZIlab3App

CFOZIlab3App theApp;


// инициализация CFOZIlab3App

BOOL CFOZIlab3App::InitInstance()
{
